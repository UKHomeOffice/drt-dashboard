...
import uk.gov.homeoffice.drt.db.{AppDatabase, FeatureGuideDao, FeatureGuideViewDao, ProdDatabase, UserAccessRequestDao, UserDao}
import uk.gov.homeoffice.drt.notifications.EmailNotifications
import uk.gov.homeoffice.drt.ports.{PortCode, PortRegion}
import uk.gov.homeoffice.drt.routes.{FeatureGuideRoutes, _}
  ...
  def apply(serverConfig: ServerConfig,
    ...
    Behaviors.setup { ctx: ActorContext[Message] =>
      ...
      val routes: Route = concat(
        ...
        FeatureGuideRoutes("guide", featureGuideService)
      )
