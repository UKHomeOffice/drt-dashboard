...
import spray.json.{ enrichAny, DefaultJsonProtocol, JsNumber, JsString, JsValue, RootJsonFormat }
...
object LegacyRegionExportJsonFormats extends DefaultJsonProtocol {
  ...
  implicit val regionExportRequestJsonFormat: RootJsonFormat[LegacyRegionExportRequest] =
    jsonFormat3(LegacyRegionExportRequest.apply)
