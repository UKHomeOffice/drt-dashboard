...
object FlightApiV1Routes extends DefaultJsonProtocol with FlightApiV1JsonFormats {
  ...
  object FlightJsonV1 {
    def apply(portCode: PortCode, ar: Arrival)(implicit sourceOrderPreference: List[FeedSource]): FlightJsonV1 =
      FlightJsonV1(
  ...
  def apply(
      ...
      dateRangeJsonForPorts: Seq[PortCode] => (SDateLike, SDateLike) => Future[FlightJsonResponseV1]
  ): Route =
