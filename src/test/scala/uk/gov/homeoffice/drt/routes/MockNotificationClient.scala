...
class MockNotificationClient extends NotificationClientApi {
  ...
  override def sendEmail(
      templateId: String,
      emailAddress: String,
      personalisation: util.Map[String, _],
      reference: String
  ): SendEmailResponse = {
  ...
  override def sendPrecompiledLetterWithInputStream(
      reference: String,
      stream: InputStream,
      postage: String
  ): LetterResponse = ???
